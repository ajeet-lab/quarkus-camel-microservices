...
public class ProductBE extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        onException(Exception.class)
            ...
            .setProperty("MaskFields", simple("{{route.products_MaskFields}}"))
        ...
        from("direct:products")
                ...
                .convertBodyTo(String.class)
                .setProperty("processName", simple("{{route.products_ProcessName}}"))
                ...
                .choice()
                    ...
                    .doTry()
                    .log("In ${routeId} and conservation_id ${in.header.ConversationID} ${exchangeProperty.ConversationID} Calling target URL products_TargetURL with Request :: ${body}")
                    .to("{{route.products_TargetURL}}")
                    .log("In ${routeId} and conservation_id ${in.header.ConversationID} ${exchangeProperty.ConversationID} Response from products_TargetURL :: ${body}")
